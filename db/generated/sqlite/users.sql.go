...
SELECT id, username, email, password_hash, avatar_url, status, created_at, updated_at, deleted_at, platform_role, last_login_at FROM users WHERE id = ? AND deleted_at IS NULL LIMIT 1
`
...
SELECT id, username, email, password_hash, avatar_url, status, created_at, updated_at, deleted_at, platform_role, last_login_at FROM users WHERE username = ? AND deleted_at IS NULL LIMIT 1
`
